...
%                 this.setFocus([],[],L{1});
            ...
            this.menu.export = struct('main', ...
                uimenu(this.fig, 'Text','Export'));

            this.menu.export.toWS = uimenu(this.menu.export.main, ...
                Text = 'to workspace', ...
                MenuSelectedFcn = {@this.setOption, 'export2WS'});

            this.menu.export.toFile = uimenu(this.menu.export.main, ...
                Text = 'to file', ...
                MenuSelectedFcn = {@this.setOption, 'export2file'});
